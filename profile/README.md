...
<details open  style="font-size:16px;">
 <summary style="font-size:17px; font-weight:bold;">왕초보를 위한 주식코딩 스파르타강의!</summary>

- **분야:** 주식 시스템
- **난이도:** 초보-중수
- **강의신청:** [강의 상세내용 🔗](https://cafe.naver.com/programgarden/4143)  
- **예제파일:** 현장 제공
- **내용:** 초보자들의 증권 코딩 실력을 최대한 쉽고 간결하고 핵심적으로 빠르게 가르치고 실력 향상에 초점을 맞춘 강의입니다. 완강 후 스스로 코드를 확장 할 수 있는 노하우들을 전수해주고 연습하는 오프라인 강의입니다.

</details>
<br>

<details open  style="font-size:16px;">
 <summary style="font-size:17px; font-weight:bold;">터틀 캠퍼스</summary>
...
## 강의에서 활용 중인 언어와 기능들 💻
### 프로그래밍 언어
<p align="left" style="padding: 10px; border-radius:10px;">
